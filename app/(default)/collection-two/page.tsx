...
export default async function GalleryPage() {
  const artistName = <h1 className=' mb-0 text-3xl  uppercase tracking-widest lg:text-4xl xl:text-4xl'>
...
<div className='mx-auto max-w-[1960px] p-4 md:p-7 xl:p-10'>
        ...
        <MediaGallery resources={results.resources}  artistName={artistName} patronName='Jeff Meleski'/>
      </div>
    </section>
  );
}